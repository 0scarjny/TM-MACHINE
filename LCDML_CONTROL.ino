...
void LCDML_CONTROL_loop()
{
    ...
    uint8_t valuef =digitalRead(_LCDML_CONTROL_digital_quit);   // exit button
		...
		if(!valuee) {LCDML_BUTTON_enter();}	// enter
    if(!valuef) {LCDML_BUTTON_quit();} // quit
